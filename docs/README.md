...
```
MODULE_{模块字母}_{模块功能描述}.md
```

- **模块字母**：A → Z，按 Sprint 顺序递增
- **模块功能描述**：简短中文，概括该模块的核心内容
...
| 你是什么角色？ | 读哪个目录？ | 说明 |
|:--------------|:------------|:-----|
| 🤖 **前端 Dev Agent** | `docs/agent-prompts/MODULE_B_前端开发.md` | 明确你的开发范围和输出规范 |
| 🤖 **后端 Dev Agent** | `docs/agent-prompts/MODULE_B_后端开发.md` | 明确你的开发范围和输出规范 |
