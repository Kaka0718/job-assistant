...
| `MODULE_E_AI智能增强与数据导出.md` | `sprint-tasks/` | Sprint 5: 流式输出 + 关键词勾选 + 版本历史 + 数据导出 |
| `MODULE_E_前端开发.md` | `agent-prompts/` | Sprint 5: 前端开发 Agent 任务指令 |
| `MODULE_E_后端开发.md` | `agent-prompts/` | Sprint 5: 后端开发 Agent 任务指令 |
...
| 你是什么角色？ | 读哪个目录？ | 说明 |
|:--------------|:------------|:-----|
| 🤖 **前端 Dev Agent** | `docs/agent-prompts/MODULE_E_前端开发.md` | 明确你的开发范围和输出规范 |
| 🤖 **后端 Dev Agent** | `docs/agent-prompts/MODULE_E_后端开发.md` | 明确你的开发范围和输出规范 |
| 🧪 **QA Agent** | `docs/agent-prompts/MODULE_E_测试说明.md` | 明确测试范围，输出到 `docs/test-reports/` |
